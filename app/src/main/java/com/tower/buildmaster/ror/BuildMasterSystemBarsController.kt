package com.tower.buildmaster.ror
...
class BuildMasterSystemBarsController(private val activity: Activity) {
...
fun Activity.chickenSetupSystemBars() {
    BuildMasterSystemBarsController(this).chickenSetupSystemBars()
}

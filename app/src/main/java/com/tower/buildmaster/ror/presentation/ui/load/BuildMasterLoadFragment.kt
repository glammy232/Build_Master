...
import com.tower.buildmaster.MainActivity
import com.tower.buildmaster.ror.data.shar.BuildMasterSharedPreference
import com.tower.buildmaster.databinding.FragmentLoadChickenBinding
...
class BuildMasterLoadFragment : Fragment(R.layout.fragment_load_chicken) {
    private lateinit var chickenLoadBinding: FragmentLoadChickenBinding

    private val volcanoLoadViewModel by viewModel<BuildMasterLoadViewModel>()

    private val chickenSharedPreference by inject<BuildMasterSharedPreference>()
        ...
        lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                volcanoLoadViewModel.chickenHomeScreenState.collect {
                    when (it) {
                        is BuildMasterLoadViewModel.ChickenHomeScreenState.ChickenLoading -> {

                        }

                        is BuildMasterLoadViewModel.ChickenHomeScreenState.ChickenError -> {
                        ...
                        is BuildMasterLoadViewModel.ChickenHomeScreenState.ChickenSuccess -> {
                        ...
                        BuildMasterLoadViewModel.ChickenHomeScreenState.ChickenNotInternet -> {
